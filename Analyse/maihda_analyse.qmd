...
p_counts <- ggplot(freq_df, aes(x = n_surveys, y = n_personen)) +
  geom_col(fill = "#2F2E41", width = 0.8) +
...
ggplot(se_plot, aes(
  ...
  geom_point(size = 3, color = "2F2E41") +
  geom_errorbar(aes(ymin = ci_lower, ymax = ci_upper), width = 0.2, color = "2F2E41") +
