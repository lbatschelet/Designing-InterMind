...
\newglossaryentry{lic:agpl}{
  ...
  description={Freie Copyleft-Lizenz (GNU \emph{Affero General Public License}, Version~3),
  entwickelt für netzwerkbasierte Software. Sie verlangt, dass bei Bereitstellung
  über ein Netzwerk der vollständige Quellcode einschließlich aller Änderungen unter
...
\newglossaryentry{tech:sql}{
  ...
  text={SQL},
  sort={sql},
  description={\emph{Structured Query Language}, eine standardisierte Abfragesprache zur Definition, Abfrage und Manipulation von Daten in relationalen \glspl[noindex]{datenbank}.}
}
